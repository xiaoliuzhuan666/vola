...
0. **Product Principle**: Vola is a private Agent knowledge hub for individuals and small teams. It keeps profile, memory, projects, skills, MCP, prompts, and playbooks in one Hub, then safely syncs supported assets to local tools such as Codex and Claude Code. See `docs/core-principles.zh-CN.md`.
